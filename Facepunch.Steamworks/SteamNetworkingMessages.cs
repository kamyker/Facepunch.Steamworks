...
namespace Steamworks
{
	public class SteamNetworkingMessages : SteamSharedClass<SteamNetworkingMessages>
	{
		...
		{
			Dispatch.Install<SteamNetworkingMessagesSessionRequest_t>( x =>
			{
				if ( AcceptSessionWithUser( x.DentityRemote ) )
				{
					OnAcceptedSessionWithUser?.Invoke( x.DentityRemote.SteamId );
				}
			}, server );
		...
		/// </summary>
		public static Action<SteamId> OnAcceptedSessionWithUser;
		...
		/// </summary>
		public static bool AcceptSessionWithUser( NetIdentity user ) => Internal.AcceptSessionWithUser( ref user );
		//
		// /// <summary>
